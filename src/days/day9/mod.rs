...
impl Board {
    ...
    fn follow_tail(&mut self, head: Point, tail: &mut Point, tail_index: usize) {
        ...
        self.tail.remove(tail_index);
        self.tail.insert(tail_index, tail.clone());
...
pub(crate) fn part2() -> usize {
    ...
    let mut board = Board {
        head: Point { x: 0, y: 0 },
        tail: vec![Point { x: 0, y: 0 }, Point { x: 0, y: 0 }, Point { x: 0, y: 0 }, Point { x: 0, y: 0 }, Point { x: 0, y: 0 }, Point { x: 0, y: 0 }, Point { x: 0, y: 0 }, Point { x: 0, y: 0 }, Point { x: 0, y: 0 }],
        tail_visited: HashSet::new(),
    };
    board.tail_visited.insert(Point { x: 0, y: 0 });
    for (_idx, line) in lines {
